...
INSERT INTO orders (resource_id, user_id, order_number, status, payment_status, subtotal, tax_amount, shipping_amount, discount_amount, total_amount, currency, notes, shipping_address, billing_address, shipped_at, delivered_at, created_at, updated_at) VALUES
('order-001', 2, 'ORD-2024-001', 'delivered', 'paid', 999.00, 79.92, 0.00, 0.00, 1078.92, 'USD', 'Please deliver during business hours', '{"first_name":"John","last_name":"Doe","address_line_1":"123 Main St","city":"New York","state":"NY","postal_code":"10001","country":"USA"}', '{"first_name":"John","last_name":"Doe","address_line_1":"123 Main St","city":"New York","state":"NY","postal_code":"10001","country":"USA"}', DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), NOW()),
('order-002', 3, 'ORD-2024-002', 'shipped', 'paid', 2499.00, 199.92, 25.00, 100.00, 2623.92, 'USD', 'Fragile - handle with care', '{"first_name":"Jane","last_name":"Smith","address_line_1":"456 Oak Ave","city":"Los Angeles","state":"CA","postal_code":"90210","country":"USA"}', '{"first_name":"Jane","last_name":"Smith","address_line_1":"456 Oak Ave","city":"Los Angeles","state":"CA","postal_code":"90210","country":"USA"}', DATE_SUB(NOW(), INTERVAL 2 DAY), NULL, DATE_SUB(NOW(), INTERVAL 4 DAY), NOW()),
('order-003', 2, 'ORD-2024-003', 'processing', 'processing', 399.00, 31.92, 15.00, 0.00, 445.92, 'USD', 'Gift wrapping requested', '{"first_name":"John","last_name":"Doe","address_line_1":"123 Main St","city":"New York","state":"NY","postal_code":"10001","country":"USA"}', '{"first_name":"John","last_name":"Doe","address_line_1":"123 Main St","city":"New York","state":"NY","postal_code":"10001","country":"USA"}', NULL, NULL, DATE_SUB(NOW(), INTERVAL 1 DAY), NOW()),
('order-004', 4, 'ORD-2024-004', 'pending', 'pending', 1199.00, 95.92, 0.00, 50.00, 1244.92, 'USD', NULL, '{"first_name":"Mike","last_name":"Wilson","address_line_1":"789 Pine St","city":"San Francisco","state":"CA","postal_code":"94102","country":"USA"}', '{"first_name":"Mike","last_name":"Wilson","address_line_1":"789 Pine St","city":"San Francisco","state":"CA","postal_code":"94102","country":"USA"}', NULL, NULL, DATE_SUB(NOW(), INTERVAL 3 HOUR), NOW()),
('order-005', 5, 'ORD-2024-005', 'delivered', 'paid', 249.00, 19.92, 0.00, 0.00, 268.92, 'USD', 'Left at front door', '{"first_name":"Sarah","last_name":"Jones","address_line_1":"321 Elm St","city":"Chicago","state":"IL","postal_code":"60601","country":"USA"}', '{"first_name":"Sarah","last_name":"Jones","address_line_1":"321 Elm St","city":"Chicago","state":"IL","postal_code":"60601","country":"USA"}', DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 5 DAY), NOW());
